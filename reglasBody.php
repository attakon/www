...
?>
<body>
    <table border="0" width="780" height="27" style="border-collapse: collapse">
        <tr>
            <td height="8" width="23"><span style="font-weight: 700">&nbsp; </span>
            </td>
            <td height="8" width="363"><span style="font-weight: 700">
                <a class="rulesMark" href="#Quien_es_Elegible">Quien es Elegible</a> </span>
            </td>
            <td height="8" width="388"><a class="rulesMark" href="#Normas_de_participación"><b>Normas de Participaci&oacute;n</b><span style="font-weight: 700">&nbsp; </span>
            </a><span style="font-weight: 700">&nbsp;</span></td>
        </tr>
        <tr>
            <td height="9" width="23" rowspan="2"><span style="font-weight: 700">
                &nbsp;&nbsp; </span>
            </td>
            <td height="34" width="363"><span style="font-weight: 700">
            <a class="rulesMark" href="#Como_Registrarme">Como Registrarme</a></span></td>
    ...
    <ul>
        <li>Es Elegible de participar toda persona que tenga 13 a&ntilde;os o m&aacute;s.</li>        
    ...
    <hr size="4" color="#000000">
    <blockquote>
        <p><span style="font-weight: 700"><font size="4"><a name="Como_Registrarme">Como
        Registrarme</a></font></span></p>
    </blockquote>
    ...
    <hr color="#000000" size="1">
    <ul>
        <li>Los Concursos Individuales (CI) es obviamente es de una persona por cuenta y por computador.</li>
    ...
    <blockquote>
        <p><span style="FONT-WEIGHT: bold">Entorno</span><br>Ud. puede usar cualquier lenguaje de programaci&oacute;n para resolver los problemas.
            ...
            concursante sabr&aacute; inmediatamente si su respuesta fue correcta. <br><br>
            <span style="FONT-WEIGHT: bold">Presentando el C&oacute;digo fuente</span><br>Ud. debe cargar su c&oacute;digo fuente usado para resolver cada conjunto input/output
            al mismo tiempo que presenta su soluci&oacute;n. Por ejemplo, si Ud. genera c&oacute;digo
            autom&aacute;ticamente, presenta el generador. Ud. no puede presentar c&oacute;digo fuente
            despu&eacute;s del concurso. El administrador deber&aacute; ser capaz de reproducir su salida
            usando su c&oacute;digo fuente.<br><br><span style="FONT-WEIGHT: bold">Puntuaci&oacute;n</span><br>Por cada problema que Ud. resuelva correctamente, Ud. obtendr&aacute;
            cantidad de
            puntos indicado para ese problema, Si hay un empate en puntaje la persona con
        menos tiempo de penalizaci&oacute;n gana.</p>
        ...
        Por ejemplo, si tu has hecho los siguientes intentos:<p>[17m10s]
            ...
            [18m15s] intento correcto para A (10 pts)<br>
            [29m30s] intento fallido para B<br>
